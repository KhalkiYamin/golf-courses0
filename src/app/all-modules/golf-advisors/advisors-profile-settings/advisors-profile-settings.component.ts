...
@Component({
  selector: 'app-advisors-profile-settings',
  templateUrl: './advisors-profile-settings.component.html',
  styleUrls: ['./advisors-profile-settings.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class AdvisorsProfileSettingsComponent implements OnInit {
